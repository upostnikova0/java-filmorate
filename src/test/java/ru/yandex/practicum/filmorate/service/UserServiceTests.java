...
//        assertEquals(user2, userService.findUser(user2.getId()));
//    }
//
//    @Test
...
//
//        assertEquals("Акакий", userService.findUser(user1.getId()).getName());
//    }
//
//    @Test
...
//
//        assertTrue(userService.findUser(user1.getId()).getFriends().contains(user2.getId()));
//        assertTrue(userService.findUser(user2.getId()).getFriends().contains(user1.getId()));
//    }
//
//    @Test
...
//
//        assertTrue(userService.findUser(user1.getId()).getFriends().isEmpty());
//        assertTrue(userService.findUser(user2.getId()).getFriends().isEmpty());
//    }
//
//    @Test
