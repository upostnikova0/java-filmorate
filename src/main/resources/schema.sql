DROP TABLE IF EXISTS MPA_RATING, GENRES, FILMS, FILM_GENRES, USERS, LIKES, USER_FRIENDS, DIRECTORS, FILM_DIRECTORS,
reviews_likes, reviews_dislikes, reviews CASCADE;
...
CREATE TABLE IF NOT EXISTS FILM_DIRECTORS (
    ...
    CONSTRAINT film_directors_pk FOREIGN KEY (film_id) REFERENCES FILMS (film_id),
    CONSTRAINT director_pk FOREIGN KEY (director_id) REFERENCES DIRECTORS (director_id)
);
